class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _translations = {
    'zh': {
      ...
      'home.pickDirFailed': '无法打开文件选择器：当前环境缺少桌面门户（XDG portal）。请安装 xdg-desktop-portal 或改用终端手动分享。',
    ...
    'en': {
      ...
      'home.pickDirFailed': 'Could not open the file picker: no desktop portal (XDG portal) available. Install xdg-desktop-portal or share via a terminal instead.',
    ...
    'zhTW': {
      ...
      'home.pickDirFailed': '無法開啟檔案選擇器：目前環境缺少桌面入口（XDG portal）。請安裝 xdg-desktop-portal 或改用終端手動分享。',
